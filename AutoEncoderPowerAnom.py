...
def check_anomaly(img_path):
    ...
    if density < uninfected_values[0] - 5 * uninfected_values[1] or density > uninfected_values[0] + 5 * uninfected_values[1] or recon_error > uninfected_values[2] + 5 * uninfected_values[3]:
